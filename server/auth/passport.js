...
var configAuth = require('./_config');
...
// module.exports = function(passport) {
    ...
    function(req, email, password, done) {
        ...
        process.nextTick(function() {
            ...
            User.findOne({'local.email': email}, function(err, existingUser, info) {
